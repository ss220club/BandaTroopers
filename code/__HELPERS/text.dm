...
/proc/reject_bad_name(t_in, allow_numbers = 0, max_length = MAX_NAME_LEN, allow_signs = TRUE)
	...
	for(var/i=1, i<=length_char(t_in), i++) //SS220 EDIT CHANGE - Cyrillic Fixes
		...
		switch(ascii_char)
			// A  .. Z
			if(65 to 90, 1040 to 1071, 1025) //Uppercase Letters //BANDATROOPERS EDIT CHANGE - Cyrillic Fixes
				t_out += ascii2text(ascii_char)
				number_of_alphanumeric++
				last_char_group = 4

			// a  .. z
			if(97 to 122, 1072 to 1103, 1105) //Lowercase Letters //BANDATROOPERS EDIT CHANGE - Cyrillic Fixes
