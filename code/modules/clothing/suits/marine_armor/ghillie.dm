...
// No baked-in webbing version, only the FORECON version because it doesn't look like complete ass

/obj/item/clothing/suit/marine/ghillie
	name = "M3 UDEP Thermal Poncho"
	desc = "A barebones set of M3 armor, with a thermal poncho draped over the top to provide camouflage capabilities."
	desc_lore = "UDEP or the Ultra Diffusive Environmental Poncho is a camouflaged rain-cover worn to protect against the elements and chemical spills. It's commonly treated with an infrared absorbing coating, making a marine almost invisible in the rain. Favoured by USCM scout-snipers for it's comfort and practicality when not wearing a full ghillie suit."
	icon_state = "mercenary_miner_armor"
	flags_atom = NO_SNOW_TYPE|NO_NAME_OVERRIDE
	armor_bio = CLOTHING_ARMOR_MEDIUMHIGH
	slowdown = SLOWDOWN_ARMOR_VERY_LIGHT
...
/obj/item/clothing/suit/marine/ghillie/invis
	full_camo_alpha = FULL_CAMOUFLAGE_ALPHA
	current_camo = FULL_CAMOUFLAGE_ALPHA
	visible_camo_alpha = VISIBLE_CAMOUFLAGE_ALPHA
