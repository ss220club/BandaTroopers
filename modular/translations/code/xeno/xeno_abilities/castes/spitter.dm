...
/datum/action/xeno_action/onclick/charge_spit
	desc = "Собирает кислоту в гландах, повышая скорость передвижения и броню (%ARMOR%).\
		...
		<br>На цели будет создана кислота, наносящая %ACID_HUMAN% в секунду урона носителям и %ACID_STR% в секунду объектам в течении (%TIME%).\
...
/datum/action/xeno_action/onclick/charge_spit/apply_replaces_in_desc()
	...
	replace_in_desc("%ACID_HUMAN%", /datum/effects/acid::damage_per_process_human)
	replace_in_desc("%ACID_STR%", /datum/effects/acid::damage_per_process_object)
